...
/**
 * Servlet implementation class ConsumoPorEquipamento
 */
@SuppressWarnings("serial")
@WebServlet(name="ConsumoPorEquipamento", urlPatterns = "/ConsumoPorEquipamento")
public class ConsumoPorEquipamento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {          
            ...
            InputStream inputStream = getServletContext().getResourceAsStream("WEB-INF/reports/ConsumoPorClienteEquip.jasper");
