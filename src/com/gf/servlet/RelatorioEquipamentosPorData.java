...
/**
 * Servlet implementation class RelatorioEquipamentosPorData
 */
@SuppressWarnings("serial")
@WebServlet(name="RelatorioEquipamentosPorData", urlPatterns = "/RelatorioEquipamentosPorData")
public class RelatorioEquipamentosPorData extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {          
            ...
            InputStream inputStream = getServletContext().getResourceAsStream("/WEB-INF/reports/repControlePorData.jasper");
