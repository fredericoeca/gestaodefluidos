...
/**
 * Servlet implementation class EmailResetSenha
 */
@SuppressWarnings("serial")
@WebServlet(name="EmailResetSenha", urlPatterns = "/EmailResetSenha")
public class EmailResetSenha extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {   
            ...
            String assunto = "Restauração de senha";
            String comenta = "Olá, "+ to
            		+ ",\n\nsua senha é: " + senhaAleatoria + "\n\nAo acessar o sistema, recomendamos altera-la."
