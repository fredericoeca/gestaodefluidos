...
/**
 * Servlet implementation class ConsumoEquip
 */
@SuppressWarnings("serial")
@WebServlet(name="ConsumoEquip", urlPatterns = "/ConsumoEquip")
public class ConsumoEquip extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {          
            ...
            InputStream inputStream = getServletContext().getResourceAsStream("WEB-INF/reports/ConsumoPorEquip.jasper");
            ...
            parametros.put("dt_in", d1);
            parametros.put("dt_fi", d2);
