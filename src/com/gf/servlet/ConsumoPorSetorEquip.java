...
/**
 * Servlet implementation class ConsumoPorSetorEquip
 */
@SuppressWarnings("serial")
@WebServlet(name="ConsumoPorSetorEquip", urlPatterns = "/ConsumoPorSetorEquip")
public class ConsumoPorSetorEquip extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {          
            ...
            int set = Integer.parseInt(setor);
            
            InputStream inputStream = getServletContext().getResourceAsStream("WEB-INF/reports/ConsumoPorSetorEquip.jasper");
