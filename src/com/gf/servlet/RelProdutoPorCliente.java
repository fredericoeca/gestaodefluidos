...
/**
 * Servlet implementation class RelProdutoPorCliente
 */
@SuppressWarnings("serial")
@WebServlet(name="RelProdutoPorCliente", urlPatterns = "/RelProdutoPorCliente")
public class RelProdutoPorCliente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {          
            ...
            InputStream inputStream = getServletContext().getResourceAsStream("WEB-INF/reports/ProdutoPorCliente.jasper");
