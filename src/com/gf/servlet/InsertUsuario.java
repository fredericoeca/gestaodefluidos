...
/**
 * Servlet implementation class InsertUsuario
 */
...
public class InsertUsuario extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            response.sendRedirect("usuarios.jsp?c=7");
            
        } catch (SQLException ex) {
            System.out.println(ex);
            response.sendRedirect("ins_usuario.jsp?c=1");
        } catch (EmailExistingException ex) {
            System.out.println(ex);
            response.sendRedirect("ins_usuario.jsp?c=2");
        } catch(Exception ex){
            System.out.println(ex);
            response.sendRedirect("ins_usuario.jsp?c=3");
        }
    }
