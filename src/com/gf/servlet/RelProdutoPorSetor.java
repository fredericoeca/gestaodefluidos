...
/**
 * Servlet implementation class RelProdutoPorSetor
 */
@SuppressWarnings("serial")
@WebServlet(name="RelProdutoPorSetor", urlPatterns = "/RelProdutoPorSetor")
public class RelProdutoPorSetor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {          
            ...
            InputStream inputStream = getServletContext().getResourceAsStream("WEB-INF/reports/ProdutoPorSetor.jasper");
