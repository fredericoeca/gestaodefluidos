...
/**
 * Servlet implementation class InsertControleForEquip
 */
@SuppressWarnings("serial")
@WebServlet(name="InsertControleForEquip", urlPatterns = "/InsertControleForEquip")
public class InsertControleForEquip extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String equipamento = request.getParameter("val42");
            String sid = request.getParameter("val43");
            ...
            if(sid.equals("null")) {
            	response.sendRedirect("equipamentos.jsp?c=10");
            } else {
            	response.sendRedirect("equipamentos.jsp?sid=" + sid + "&c=10");
            }
            
        } catch (SQLException e) {
			System.out.println("Error of database in InsertControleForEquip Servlet - " + e);
			response.sendRedirect("equipamentos.jsp?c=7");
		} catch (RadioSelectedException e) {
			System.out.println("Error of RadioButtonSelected in InsertControleForEquip Servlet - " + e);
			response.sendRedirect("equipamentos.jsp?c=8");
		}  catch (Exception e) { 
            System.out.println("Error generic em InsertControleForEquip Servlet - " + e);
            response.sendRedirect("equipamentos.jsp?c=9");
        } 
